...
//
  ...
  TH1F* hS1  = new TH1F("hS1", "hS1",MAX_nentries,0.0,10.0);
  E->Draw("eKinEnergy>>hS1","TMath::Cos(eTheta)>0.0","");
  hS1->Scale(scale*1.0); // 
  ...
  TH1F* hS2  = new TH1F("hS2", "hS2",MAX_nentries,0.0,10.0);
  E->Draw("eKinEnergy>>hS2","TMath::Cos(eTheta)>0.0","");
  hS2->Scale(scale*1.0); // 
  ...
  TH1F* hS3  = new TH1F("hS3", "hS3",MAX_nentries,0.0,10.0);
  E->Draw("eKinEnergy>>hS3","TMath::Cos(eTheta)>0.0","");
  hS3->Scale(scale*1.0); // 
  ...
  TH1F* hS4  = new TH1F("hS4", "hS4",MAX_nentries,0.0,10.0);
  E->Draw("eKinEnergy>>hS4","TMath::Cos(eTheta)>0.0","");
  hS4->Scale(scale*1.0); // 
  ...
  TH1F* hS5  = new TH1F("hS5", "hS5",MAX_nentries,0.0,10.0);
  E->Draw("eKinEnergy>>hS5","TMath::Cos(eTheta)>0.0","");
  hS5->Scale(scale*1.0); // 
  ...
  TH1F* hS6  = new TH1F("hS6", "hS6",MAX_nentries,0.0,10.0);
  E->Draw("eKinEnergy>>hS6","TMath::Cos(eTheta)>0.0","");
  hS6->Scale(scale*1.0); // 
  ...
  TH1F* hS7  = new TH1F("hS7", "hS7",MAX_nentries,0.0,10.0);
  E->Draw("eKinEnergy>>hS7","TMath::Cos(eTheta)>0.0","");
  hS7->Scale(scale*1.0); // 
