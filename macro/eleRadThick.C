...
//
  ...
  E->Draw("eKinEnergy>>hS1","eKinEnergy>0.0","");
  hS1->Scale(scale*1.0); // 
  ...
  E->Draw("eKinEnergy>>hS2","eKinEnergy>0.0","");
  hS2->Scale(scale*1.0); // 
  ...
  E->Draw("eKinEnergy>>hS3","eKinEnergy>0.0","");
  hS3->Scale(scale*1.0); // 
  ...
  E->Draw("eKinEnergy>>hS4","eKinEnergy>0.0","");
  hS4->Scale(scale*1.0); // 
  ...
  E->Draw("eKinEnergy>>hS5","eKinEnergy>0.0","");
  hS5->Scale(scale*1.0); // 
  ...
  E->Draw("eKinEnergy>>hS6","eKinEnergy>0.0","");
  hS6->Scale(scale*1.0); // 
  ...
  E->Draw("eKinEnergy>>hS7","eKinEnergy>0.0","");
  hS7->Scale(scale*1.0); // 
